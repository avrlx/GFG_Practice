<h2><a href="https://www.geeksforgeeks.org/problems/arithmetic-operators-1605594922/1?page=1&category=Java&sortBy=submissions">Arithmetic Operators</a></h2><h3>Difficulty: Basic</h3><hr><p><span style="font-size: 18px;">Given two integer variables <strong>x</strong> and <strong>y</strong>. You need to perform the following operations:</span></p>
<ul>
